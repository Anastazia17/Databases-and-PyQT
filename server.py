...
Открывается окно "Messaging Server alpha release", работает корректно, 
отображает виджет-окна "История клиентов" и "Настройки сервера", 
обновляет список, кнопка "Выход" работает.
"""